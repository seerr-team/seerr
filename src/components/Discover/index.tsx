        ...
        <>
          ...
          >
            <button
              ...
              className="h-12 w-12 rounded-full border-2 border-gray-600 bg-gray-700/90 p-3 text-gray-400 shadow-sm transition-all hover:bg-gray-700"
            >
          ...
          <Transition
            ...
            className="safe-shift-edit-menu fixed right-0 left-0 z-50 flex flex-col items-center justify-end space-y-2 space-x-0 border-t border-gray-700 bg-gray-800/80 p-4 backdrop-blur-sm sm:bottom-0 sm:flex-row sm:space-y-0 sm:space-x-3"
          >
            <Button
              buttonType="default"
