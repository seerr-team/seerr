      ...
      <div className="flex flex-1 items-center justify-between truncate rounded-md border-t border-r border-b border-gray-700 bg-gray-600">
        ...
        <div className="shrink-0 pr-2">
          <span
            ...
            } relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-3 focus:ring-blue-500/50 focus:outline-hidden`}
          >
            <span
              aria-hidden="true"
              className={`${
