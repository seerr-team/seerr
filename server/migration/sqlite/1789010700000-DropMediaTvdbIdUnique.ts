...
// Hand-written because "tvdbId" got its UNIQUE from a column-level flag, which
// never reaches metadata.uniques, so the generated rebuild re-adds it forever.
export class DropMediaTvdbIdUnique1789010700000 implements MigrationInterface {
  name = 'DropMediaTvdbIdUnique1789010700000';
