...
const KeyMap: Record<string, string | KeyMapFunction> = {
  ...
  requestedBy_phoneNumber: 'request.requestedBy.phoneNumber',
  ...
  reportedBy_phoneNumber: 'issue.createdBy.phoneNumber',
  ...
  commentedBy_phoneNumber: 'comment.user.phoneNumber',
