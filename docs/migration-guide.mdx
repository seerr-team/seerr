...
See [Backups](/docs/using-seerr/backups) for details on how to properly backup your instance.
:::

## Docker
Refer to [Seerr Docker Documentation](/docs/getting-started/docker), all of our examples have been updated to reflect the below change.
...
## Kubernetes
Refer to [Seerr Kubernetes Documentation](/docs/getting-started/kubernetes), all of our examples have been updated to reflect the below change.
