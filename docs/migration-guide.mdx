...
Follow the [Unraid Installation Guide](/getting-started/third-parties/unraid), **starting from step 2** — this covers setting the correct folder permissions and adding the Docker container.
