...
<Tabs groupId="media-server-type" queryString>
  <TabItem value="jellyfin" label="Jellyfin">
    ...
    If multiple Jellyfin servers are configured, Seerr will show a separate import action for each configured server.
...
:::
  ...
  <TabItem value="emby" label="Emby">
    ...
    If multiple Emby servers are configured, Seerr will show a separate import action for each configured server.
...
:::
  ...
  <TabItem value="plex" label="Plex">
    ...
    If multiple Plex servers are configured, Seerr will show a separate import action for each configured server.
