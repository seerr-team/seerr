...
Seerr uses port 5055. If this port is already in use by another application, you will need to identify and remove the conflicting service before Seerr can start.
...
- [SynoCommunity](https://synocommunity.com/) - Community package repository
- [SynoCommunity GitHub](https://github.com/SynoCommunity/spksrc) - Source code and issue tracker
- [Seerr Documentation](/) - Official Seerr documentation
